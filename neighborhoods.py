...
NEIGHBORHOODS = {
    ...
    "Kalihi": {
        "island": "Oahu",
        "region": "Urban Honolulu",
        "vibe": "Kalihi is one of Honolulu's most densely populated and culturally diverse urban neighborhoods — a working-class community with deep Filipino, Samoan, Micronesian, and Pacific Islander roots. It's authentic urban Honolulu without the tourist overlay, and one of the few remaining affordable entry points close to downtown.",
        "lifestyle": "Life in Kalihi is community-centered and unpretentious. Palama Settlement, the Kalihi YMCA, and local churches anchor the neighborhood. Sand Island Beach Park is minutes away. The food scene is genuinely excellent if you know where to look — Filipino bakeries, Korean BBQ, and plate lunch spots that locals have been going to for decades.",
        "nearby": ["Palama Settlement", "Kalihi Valley", "Sand Island Beach Park", "Honolulu Community College", "Dillingham Boulevard corridor", "Liliha Bakery"],
        "beaches": ["Sand Island Beach Park (not a swim beach)", "Ala Moana Beach (15 min)"],
        "commute": "H-1 and surface streets to downtown Honolulu — 10-15 min. Excellent TheBus access. Rail station planned along the Dillingham corridor.",
        "market_notes": "One of the most affordable urban Oahu markets. Mix of older single-family homes, small multifamily, and some newer infill. Fee simple dominant. Strong rental demand from working families and recent immigrants. Investor market active. Older housing stock means deferred maintenance is common — buyers should inspect carefully. Rail corridor investment is a long-term value catalyst.",
        "keywords": ["affordable", "diverse", "working-class", "Filipino", "Pacific Islander", "urban", "transit", "rail corridor"],
        "aliases": ["Kalihi Oahu", "Kalihi Valley", "Kalihi-Palama", "Kalihi Honolulu", "Lower Kalihi", "Upper Kalihi"]
    },
...
def get_neighborhood_context(neighborhood_input, island_input=None):
    ...
    all_names = list(NEIGHBORHOODS.keys())
    fuzzy_matches = difflib.get_close_matches(query, all_names, n=1, cutoff=0.7)
    if fuzzy_matches:
        matched_data = NEIGHBORHOODS[fuzzy_matches[0]]
        if matches_island(matched_data):
            return matched_data
    ...
    if fuzzy_alias:
        matched_data = alias_map[fuzzy_alias[0]]
        if matches_island(matched_data):
            return matched_data
...
# FUZZY MATCH RISK AUDIT
# Generated by difflib.SequenceMatcher at cutoff 0.7 across all neighborhood names + aliases.
# These pairs could produce cross-island contamination if the island guard is ever weakened.
# Do not fix automatically — review each pair and decide whether aliases need disambiguation.
#
# [Waimea] (Big Island) — could match [Waimea (alias of Waimea Valley)] (Oahu) — similarity: 1.0
# [Kailua] (Oahu) — could match [Wailua] (Kauai) — similarity: 0.833
# [Kapalua] (Maui) — could match [Kapaa] (Kauai) — similarity: 0.833
# [Wailea] (Maui) — could match [Waimea] (Big Island) — similarity: 0.833
# [Wailea] (Maui) — could match [Wailua] (Kauai) — similarity: 0.833
# [Lanikai] (Oahu) — could match [Lanai (alias of Lanai City)] (Lanai) — similarity: 0.833
# [Kahala] (Oahu) — could match [Kohala (alias of Kohala Coast)] (Big Island) — similarity: 0.833
# [Wailea] (Maui) — could match [Waimea (alias of Waimea Valley)] (Oahu) — similarity: 0.833
# [Kailua-Kona] (Big Island) — could match [Kailua-Oahu (alias of Kailua)] (Oahu) — similarity: 0.818
# [Aiea] (Oahu) — could match [Wailea] (Maui) — similarity: 0.8
# [Aiea] (Oahu) — could match [Waimea] (Big Island) — similarity: 0.8
# [Mililani] (Oahu) — could match [Leilani (alias of Leilani Estates)] (Big Island) — similarity: 0.8
# [Waimea Valley] (Oahu) — could match [Lawai Valley (alias of Lawai)] (Kauai) — similarity: 0.8
# [Lawai] (Kauai) — could match [Lanai (alias of Lanai City)] (Lanai) — similarity: 0.8
# [Kailua] (Oahu) — could match [Kapalua] (Maui) — similarity: 0.769
# [Kailua] (Oahu) — could match [Kilauea] (Kauai) — similarity: 0.769
# [Kahala] (Oahu) — could match [Kapalua] (Maui) — similarity: 0.769
# [Kahuku] (Oahu) — could match [Kahului] (Maui) — similarity: 0.769
# [Wailuku] (Maui) — could match [Wailua] (Kauai) — similarity: 0.769
# [Kapalua] (Maui) — could match [Kapa'a (alias of Kapaa)] (Kauai) — similarity: 0.769
# [Koloa] (Kauai) — could match [Waikoloa (alias of Kohala Coast)] (Big Island) — similarity: 0.769
# [Wailua] (Kauai) — could match [Kai Lua (alias of Kailua)] (Oahu) — similarity: 0.769
# [Hawaii Kai] (Oahu) — could match [Lawai Kauai (alias of Lawai)] (Kauai) — similarity: 0.762
# [Ewa Beach] (Oahu) — could match [Wailea Beach (alias of Wailea)] (Maui) — similarity: 0.762
# [Big Island] (Big Island) — could match [Maui Island (alias of Maui)] (Maui) — similarity: 0.762
# [Aiea] (Oahu) — could match [Paia] (Maui) — similarity: 0.75
# [Hawaii Kai] (Oahu) — could match [Hawaii (alias of Big Island)] (Big Island) — similarity: 0.75
# [Lahaina] (Maui) — could match [Ainahaina (alias of Aina Haina)] (Oahu) — similarity: 0.75
# [Waimea Valley] (Oahu) — could match [Wailuku Valley (alias of Wailuku)] (Maui) — similarity: 0.741
# [Wailuku] (Maui) — could match [Wailua Kauai (alias of Wailua)] (Kauai) — similarity: 0.737
# [Kailua] (Oahu) — could match [Kauai] (Kauai) — similarity: 0.727
# [Kahala] (Oahu) — could match [Kapaa] (Kauai) — similarity: 0.727
# [Manoa] (Oahu) — could match [Makena] (Maui) — similarity: 0.727
# [Kalihi] (Oahu) — could match [Kihei] (Maui) — similarity: 0.727
# [Hana] (Maui) — could match [Hanalei] (Kauai) — similarity: 0.727
# [Wailea] (Maui) — could match ['Aiea (alias of Aiea)] (Oahu) — similarity: 0.727
# [Kula] (Maui) — could match [Kamuela (alias of Waimea)] (Big Island) — similarity: 0.727
# [Hana] (Maui) — could match [Hanappe (alias of Hanapepe)] (Kauai) — similarity: 0.727
# [Koloa] (Kauai) — could match [Kohala (alias of Kohala Coast)] (Big Island) — similarity: 0.727
# [Lawai] (Kauai) — could match [Hawaii (alias of Big Island)] (Big Island) — similarity: 0.727
# [Waimea] (Big Island) — could match ['Aiea (alias of Aiea)] (Oahu) — similarity: 0.727
# [Kailua-Kona] (Big Island) — could match [Kailua Oahu (alias of Kailua)] (Oahu) — similarity: 0.727
# [Kailua-Kona] (Big Island) — could match [Kailua Town (alias of Kailua)] (Oahu) — similarity: 0.727
# [Big Island] (Big Island) — could match [Lanai Island (alias of Lanai City)] (Lanai) — similarity: 0.727
# [Big Island] (Big Island) — could match [Kauai Island (alias of Kauai)] (Kauai) — similarity: 0.727
# [Kakaako] (Oahu) — could match [Makawao] (Maui) — similarity: 0.714
# [Haleiwa] (Oahu) — could match [Hanalei] (Kauai) — similarity: 0.714
# [Ko Olina] (Oahu) — could match [Ko Loa (alias of Koloa)] (Kauai) — similarity: 0.714
# [Kapalua] (Maui) — could match [Kai Lua (alias of Kailua)] (Oahu) — similarity: 0.714
# [Kapalua] (Maui) — could match [Ka Hala (alias of Kahala)] (Oahu) — similarity: 0.714
# [Wailea] (Maui) — could match [Waikoloa (alias of Kohala Coast)] (Big Island) — similarity: 0.714
# [Wailua] (Kauai) — could match [Waikoloa (alias of Kohala Coast)] (Big Island) — similarity: 0.714
# [Kailua] (Oahu) — could match [Kailua-Kona] (Big Island) — similarity: 0.706
# [Aina Haina] (Oahu) — could match [Lahaina] (Maui) — similarity: 0.706
# [Kapiolani] (Oahu) — could match [Pukalani] (Maui) — similarity: 0.706
# [Kailua] (Oahu) — could match [Kailua Kona (alias of Kailua-Kona)] (Big Island) — similarity: 0.706
# [Waimea] (Big Island) — could match [Waimea Oahu (alias of Waimea Valley)] (Oahu) — similarity: 0.706
# [Hawaii Kai] (Oahu) — could match [Napili Kai (alias of Napili)] (Maui) — similarity: 0.7
# [Ala Moana] (Oahu) — could match [Kailua Kona (alias of Kailua-Kona)] (Big Island) — similarity: 0.7
# [Kailua-Kona] (Big Island) — could match [Ala-Moana (alias of Ala Moana)] (Oahu) — similarity: 0.7
